//（hxzon学习笔记）clojure源码-Namespace.java
//https://github.com/clojure/clojure/blob/master/src/jvm/clojure/lang/Namespace.java
...
public class Namespace extends AReference implements Serializable {
    ...
    //池化一个符号到本命名空间，返回一个Var。
    public Var intern(Symbol sym) {
        if (sym.ns != null) {//不能池化有命名限定的符号
            throw new IllegalArgumentException("Can't intern namespace-qualified symbol");
        }
        IPersistentMap map = getMappings();
        Object o;
        Var v = null;
        while ((o = map.valAt(sym)) == null) {//不断的尝试将sym添加到mappings中。
            if (v == null) {
                v = new Var(this, sym);
            }
